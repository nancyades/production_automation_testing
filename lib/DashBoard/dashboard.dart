...
import 'package:production_automation_testing/DashBoard/src/projectStatisticsCards.dart';
import 'package:production_automation_testing/DashBoard/src/sharedfilesitem.dart';
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text(
                  "Ongoing Project",
                  style: GoogleFonts.alegreya(fontWeight: FontWeight.bold, fontSize: 20.0),
                ),
              ),
              SizedBox(
                height: 20,
