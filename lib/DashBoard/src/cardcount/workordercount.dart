...
class WorkOrderCardView extends StatefulWidget {
  final Color? color;
  ...
  @override
  State<WorkOrderCardView> createState() => _WorkOrderCardViewState();
}

class _WorkOrderCardViewState extends State<WorkOrderCardView> {
  bool hovered = false;
